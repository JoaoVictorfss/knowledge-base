...
CREATE TABLE IF NOT EXISTS `knowledgeBase`.`articles` (
  ...
  `average_liked` INT NOT NULL,
  `great_liked` INT NOT NULL,
  `poor_liked` INT NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
INSERT INTO users(name, email, password, profile) VALUES ('knowledge base', 'admin@knowledgebase.com', '$2b$10$pEMqrMJK8J8U2wQ4W0etAO2ouCOA/m7JiVpLAa3Y1sLCy94QouUkm', 'ROLE_ADMIN');
